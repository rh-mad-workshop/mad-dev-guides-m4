...
In this part of the workshop you will use the Red Hat OpenShift API Management (RHOAM) tenant on the Developer Sandbox that you configured earlier in the lab.

== Goals of this lab
* Setup a OpenShift API Management tenant on developer sandbox
* Setup an API and manage it with OpenShift API Management
