...
`\https://<replace with staging_url>/services/products?user_key=<replace with user_key from the previous section>`
...
Congratulations! You have completed the *Manage and secure APIs with OpenShift API Mananagement* module. 