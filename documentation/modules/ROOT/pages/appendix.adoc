...
*Finding the Private endpoint of the Product Catalog service depoyed on OpenShift*
...
* You will be navigated to the Service Details page the of *catalog* service. Copy the Hostname highlighted in the screenshot below
+
